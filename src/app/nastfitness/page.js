...
const NastFitnessProfile = () => {
  ...
  const gymDetails = {
    ...
    price: "500 monthly",
    description:
      "Nast Fitness Gym offers a welcoming environment with a variety of equipment and services to help you achieve your fitness goals. Join us today!",
  };
...
export default NastFitnessProfile ;
