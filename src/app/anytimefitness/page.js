...
const AnytimeFitnessProfile = () => {
  ...
  const gymDetails = {
    ...
    location: "Pueblo De Oro, Basak, Lapu-Lapu City, Cebu",
    operatingHours: "0pen 24/7",
    contact: "09885463728",
    equipment: [
      "Treadmills",
      "Free Weights",
    ...
    price: "",
    description:
      "Anytime Fitness Gym offers a welcoming environment with a variety of equipment and services to help you achieve your fitness goals. Join us today!",
  };
    ...
    >
      ...
      <Grid container spacing={4} justifyContent="center">
        <Grid item xs={12} md={8}>
          <Card
            sx={{
              backgroundColor: "#333333", // Dark gray color that blends well with the black background
              borderRadius: "15px",
              padding: "20px",
          ...
          >
            ...
            >
              ...
              <img
                ...
                style={{
                  width: "50%", // Change the width to 50% for smaller images
...
export default AnytimeFitnessProfile;
