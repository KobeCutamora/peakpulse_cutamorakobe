...
const AltGymProfile = () => {
  ...
  const gymDetails = {
    ...
    location: "Gun.ob Lapu-Lapu City, Cebu",
    ...
    price: "400 monthly",
    description:
      "ALT Fitness Gym offers a welcoming environment with a variety of equipment and services to help you achieve your fitness goals. Join us today!",
  };
