...
const LapuLapuFitnessGymProfile = () => {
  const images = [
    "/images/llc.jpg",
    "/images/llc2.jpg",
    "/images/llc3.jpg",
  ...
  const gymDetails = {
    ...
    price: "Insert Monthly Price",
    description:
      "Lapu-Lapu Fitness Gym offers a welcoming environment with a variety of equipment and services to help you achieve your fitness goals. Join us today!",
  };
...
export default LapuLapuFitnessGymProfile;
